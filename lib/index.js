...
var Gluon, GluonError, StreamSplitter, child_process, events, getProp, root,
...
GluonError = (function(superClass) {
  extend(GluonError, superClass);

  function GluonError(message) {
